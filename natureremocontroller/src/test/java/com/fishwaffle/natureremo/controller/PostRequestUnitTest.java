...
public class PostRequestUnitTest {
    ...
    public void Users_Me_Post() {
        final User data = NatureRemo.Users_Me_POST("FishWaffle");
    ...
    public void Appliances_Post() {
        final Appliance data = NatureRemo.Appliances_Post("Test", null, "3faaa7c5-7869-4235-87df-a6432a22f595", ApplianceImage.ico_curtain);
        System.out.println(data);
        data.Delete();
        assertNotNull(data);
    }
    ...
    public void Appliances_Appliance_Post() {
        ...
        final Appliance aaa = data[0].Update(ApplianceImage.ico_av, "aaa");
