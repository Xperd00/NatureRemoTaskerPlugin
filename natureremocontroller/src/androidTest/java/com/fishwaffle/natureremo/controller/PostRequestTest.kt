...
class PostRequestTest {
    ...
    @Test
    fun appliances_Post() {
        val data = NatureRemo.appliancesPost(TOKEN, "Test", null, "3faaa7c5-7869-4235-87df-a6432a22f595", ApplianceImage.ico_curtain)
        println(data)
        data!!.delete(TOKEN)
        assertNotNull(data)
    }
    ...
    fun appliances_Appliance_Post() {
        ...
        val aaa = data!![0].update(TOKEN, ApplianceImage.ico_av, "aaa")
        println(aaa)
        assertNotNull(aaa)
    }
